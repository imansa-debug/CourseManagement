...
namespace IdentitySample.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            //IdentityResult persianResult = new IdentityResult();
            //if(result.Errors.Any(p => p == "Passwords must have at least one non letter or digit character."))
            //{
            //    persianResult
            //}
            AddErrors(result);
            ...
            foreach (var error in result.Errors)
            {
                ...
                switch (error)
                {
                    case "Passwords must have at least one non letter or digit character.":
                        ...
                        ModelState.AddModelError("", "کلمه عبور باید شامل کاراکترهای غیر حرفی مانند (@،#،$،...) باشد");
                        break;
                }
